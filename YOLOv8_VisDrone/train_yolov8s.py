...
if __name__ == '__main__':
    modelcfg_path = 'E:\\MyReposity\\YOLOv8_Ascend\\YOLO算法改进\\core\\configs\\model\\yolov8s.yaml'
    checkpoint_path = 'E:\\MyReposity\\YOLOv8_Ascend\\YOLO算法改进\\core\\checkpoints\\yolov8s.pt'
